import {Player, MinecraftServer, WebSocketConnection} from "../src/index.node";
...
export const WS_URL = "ws://localhost:25585";
export const WS_TOKEN = "jrpXKVsPgpCFF3JVVbQUDsEcvDw378gvezbcKqnK";
